...
The PHP SDK for the Genrenator API — an entity-oriented client using PHP conventions.
...
```
php/
├── genrenator_sdk.php          -- Main SDK class
...
The main class (`genrenator_sdk.php`) exports the SDK class
