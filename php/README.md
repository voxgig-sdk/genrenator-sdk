...
The PHP SDK for the Genrenator API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Genre(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Genrenator(null)->load(
    ["id" => "test01"], null
);
