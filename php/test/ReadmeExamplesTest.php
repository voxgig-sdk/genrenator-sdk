...
// Genrenator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GenrenatorSDK::test)
...
{
    private const SDK_CLASS = 'GenrenatorSDK';
    ...
    private const SDK_BASE = 'genrenator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../genrenator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
