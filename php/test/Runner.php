...
class GenrenatorTestRunner
{
    ...
    {
        $live = self::getenv('GENRENATOR_TEST_LIVE');
        $override = self::getenv('GENRENATOR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GENRENATOR_TEST_EXPLAIN');
...
class_alias('GenrenatorTestRunner', 'Runner');
class_alias('GenrenatorHelpers', 'Helpers');
