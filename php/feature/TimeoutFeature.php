...
// Genrenator SDK timeout feature
...
class GenrenatorTimeoutFeature extends GenrenatorBaseFeature
{
    ...
    private function _with_timeout(GenrenatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GenrenatorContext $_ctx, float $ms): void
    {
        $client = $this->client;
