...
// Genrenator SDK clienttrack feature
...
class GenrenatorClienttrackFeature extends GenrenatorBaseFeature
{
    ...
    public function PostConstruct(GenrenatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Genrenator-SDK';
