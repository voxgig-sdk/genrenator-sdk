...
class GenrenatorCacheFeature extends GenrenatorBaseFeature
{
    ...
    private function _through(GenrenatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
