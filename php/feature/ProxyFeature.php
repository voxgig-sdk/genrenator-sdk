...
class GenrenatorProxyFeature extends GenrenatorBaseFeature
{
    ...
    public function init(GenrenatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GenrenatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
