...
// Genrenator SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GenrenatorTestFeature extends GenrenatorBaseFeature
{
    ...
    public function init(GenrenatorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GenrenatorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GenrenatorParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GenrenatorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GenrenatorContext $ctx, $op, $args): array
    {
