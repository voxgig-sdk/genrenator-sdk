...
func NewGenreEntity(client *core.GenrenatorSDK, entopts map[string]any) *GenreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenreEntity) List(_ map[string]any, _ map[string]any) (any, error) {
