...
const testSeed = `map[string]any{"entity": map[string]any{"genre": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "story": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
