...
func TestGenreEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GENRENATOR_TEST_GENRE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func genreBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GENRENATOR_TEST_GENRE_ENTID")
