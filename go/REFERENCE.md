# Genrenator Golang SDK Reference

Complete API reference for the Genrenator Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *GenrenatorSDK`
...
#### `Genre(data map[string]any) GenrenatorEntity`

Create a new `Genre` entity instance. Pass `nil` for no initial data.

#### `Story(data map[string]any) GenrenatorEntity`
