...
// instead of `sdk.NewGenrenatorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GenrenatorSDK  { return NewGenrenatorSDK(nil) }
func Test() *GenrenatorSDK { return TestSDK(nil, nil) }
