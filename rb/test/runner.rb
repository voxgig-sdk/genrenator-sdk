...
module GenrenatorTestRunner
  ...
  def self.env_override(m)
    live = getenv("GENRENATOR_TEST_LIVE")
    override = getenv("GENRENATOR_TEST_OVERRIDE")
    ...
    explain = getenv("GENRENATOR_TEST_EXPLAIN")
    m["GENRENATOR_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GenrenatorTestRunner
Helpers = GenrenatorHelpers
Vs = VoxgigStruct
