...
The Genrenator API generates random music genres and genre-related stories based on various fragments of attributes such as instruments and adjectives.

Learn more about Genrenator API at [binaryjazz.us/genrenator-api](https://binaryjazz.us/genrenator-api/).
...
This SDK exposes the API as a small set of **semantic entities** — Genre and Story — that you
