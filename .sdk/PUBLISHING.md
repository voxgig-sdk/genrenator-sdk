...
|---|---|---|
| `ts/` | @voxgig-sdk/genrenator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/genrenator-sdk \
      --repository voxgig-sdk/genrenator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/genrenator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/genrenator-sdk --id=<id>` removes it.
