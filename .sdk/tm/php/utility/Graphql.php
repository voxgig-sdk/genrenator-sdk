...
// Genrenator SDK utility: graphql
//
...
class GenrenatorGraphql
{
    ...
    // equivalent.
    public static function body(GenrenatorContext $ctx): mixed
    {
    ...
    public static function errors(GenrenatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
