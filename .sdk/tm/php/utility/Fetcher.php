...
// Genrenator SDK utility: fetcher

class GenrenatorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GenrenatorSDK/1.0)';
    ...
    public static function call(GenrenatorContext $ctx, string $fullurl, array $fetchdef): array
    {
