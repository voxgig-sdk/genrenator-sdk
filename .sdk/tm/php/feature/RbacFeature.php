...
class GenrenatorRbacFeature extends GenrenatorBaseFeature
{
    ...
    private function _required(GenrenatorContext $ctx): ?string
    {
    ...
    private function _reject(GenrenatorContext $ctx, string $required): void
    {
    ...
    private function _track(GenrenatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
