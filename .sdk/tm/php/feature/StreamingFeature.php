...
// Genrenator SDK streaming feature
...
class GenrenatorStreamingFeature extends GenrenatorBaseFeature
{
    ...
    private function _iterate(GenrenatorResult $result): \Generator
    {
    ...
    private function _streamable(GenrenatorContext $ctx): bool
    {
