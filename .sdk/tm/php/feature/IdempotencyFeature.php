...
// Genrenator SDK idempotency feature
...
class GenrenatorIdempotencyFeature extends GenrenatorBaseFeature
{
    ...
    private function _mutating(GenrenatorContext $ctx): bool
    {
