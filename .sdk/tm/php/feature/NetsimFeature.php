...
class GenrenatorNetsimFeature extends GenrenatorBaseFeature
{
    ...
    private function _simulate(GenrenatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GenrenatorContext $ctx, array $applied): void
    {
        $client = $this->client;
