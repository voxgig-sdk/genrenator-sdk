...
// Genrenator SDK telemetry feature
...
class GenrenatorTelemetryFeature extends GenrenatorBaseFeature
{
    ...
    private function _close(GenrenatorContext $ctx, bool $ok): void
    {
