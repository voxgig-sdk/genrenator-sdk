...
// Genrenator SDK ratelimit feature
...
class GenrenatorRatelimitFeature extends GenrenatorBaseFeature
{
    ...
    private function _acquire(GenrenatorContext $ctx): void
    {
    ...
    private function _track(GenrenatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
