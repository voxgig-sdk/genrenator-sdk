...
from projectname_sdk import GenrenatorSDK
from projectname_sdk.core.spec import GenrenatorSpec
from projectname_sdk.core.result import GenrenatorResult
from projectname_sdk.core.response import GenrenatorResponse
from projectname_sdk.core.operation import GenrenatorOperation
from projectname_sdk.core.error import GenrenatorError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GenrenatorBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GenrenatorError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GenrenatorSDK.test(None, None)
        ...
        class TestInitFeature(GenrenatorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GenrenatorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GenrenatorSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GenrenatorSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GenrenatorSDK.test(None, setup_opts)
