...
class GenrenatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GenrenatorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GenrenatorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GenrenatorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
