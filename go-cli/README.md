...
AQL-driven CLI and REPL for the Genrenator SDK. Positional arguments are
...
./genrenator-cli list genre
./genrenator-cli load 1 genre
./genrenator-cli load '{id:1}' genre
