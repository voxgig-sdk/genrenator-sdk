...
func registerSDKWords(r *eng.Registry, client *sdk.GenrenatorSDK) {
...
func runOp(client *sdk.GenrenatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
