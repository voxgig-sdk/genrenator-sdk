# Genrenator TypeScript SDK Reference

Complete API reference for the Genrenator TypeScript SDK.
...
```ts
new GenrenatorSDK(options?: object)
```
...
#### `GenrenatorSDK.test(testopts?, sdkopts?)`
...
**Returns:** `GenrenatorSDK` instance in test mode.
...
Return the parent `GenrenatorSDK` instance.
