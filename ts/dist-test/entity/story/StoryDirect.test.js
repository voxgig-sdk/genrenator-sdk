...
(0, node_test_1.describe)('StoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GenrenatorSDK({
...
function liveScenariosActive() { return false && process.env.GENRENATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GenrenatorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GENRENATOR_TEST_STORY_ENTID'];
    ...
    const client = new __1.GenrenatorSDK({
        base: 'http://localhost:8080',
