...
function envOverride(m) {
    if ('TRUE' === process.env.GENRENATOR_TEST_LIVE ||
        'TRUE' === process.env.GENRENATOR_TEST_OVERRIDE) {
    ...
    m.GENRENATOR_TEST_EXPLAIN = process.env.GENRENATOR_TEST_EXPLAIN || m.GENRENATOR_TEST_EXPLAIN;
    return m;
}
