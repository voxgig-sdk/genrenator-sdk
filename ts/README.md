...
The TypeScript SDK for the Genrenator API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Genre()` — each with a small set of operations (`load`)
