# Genrenator Python SDK



The Python SDK for the Genrenator API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Genre()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/genrenator-sdk/releases)) or
...
```
py/
├── genrenator_sdk.py         -- Main SDK module
