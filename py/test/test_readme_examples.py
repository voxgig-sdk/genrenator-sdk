# Genrenator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GenrenatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GenrenatorSDK(...) and GenrenatorSDK.test(...) become
#      GenrenatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "genrenator_sdk"
_SDK_CLASS = "GenrenatorSDK"
