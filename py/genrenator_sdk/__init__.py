...
from genrenator_sdk.utility import register

# Load features
from genrenator_sdk.feature.base_feature import GenrenatorBaseFeature
from genrenator_sdk.features import _has_feature, _make_feature
...
class GenrenatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GenrenatorUtility()
        self._utility = utility

        from genrenator_sdk.config import shared_config
    ...
    def get_utility(self):
        return GenrenatorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GenrenatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
