...
type Args struct {
	Entity string         `json:"entity" jsonschema:"genre | story"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GenrenatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "genrenator_list",
		Description: "List records from Genrenator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "genrenator_load",
		Description: "Load a single record from Genrenator. " +
...
func runOp(client *sdk.GenrenatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GenrenatorSDK, name string) (sdk.GenrenatorEntity, error) {
