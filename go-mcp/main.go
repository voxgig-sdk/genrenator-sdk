// Command Genrenator-mcp is an MCP server exposing the Genrenator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Genrenator_list  — list records of an entity
//	Genrenator_load  — load a single record of an entity
//
